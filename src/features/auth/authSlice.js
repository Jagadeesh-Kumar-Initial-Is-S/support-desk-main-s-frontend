...
export const register = createAsyncThunk(
  'https://support-desk-main-s-backend.vercel.app/auth/register',
  async (user, thunkAPI) => {
    try {
...
// Login user
export const login = createAsyncThunk('https://support-desk-main-s-backend.vercel.app/auth/login', async (user, thunkAPI) => {
  try {
...
export const logout = createAction('https://support-desk-main-s-backend.vercel.app/auth/logout', () => {
  authService.logout()
