...
export const createTicket = createAsyncThunk(
  'https://support-desk-main-s-backend.vercel.app/tickets/create',
...
export const getTickets = createAsyncThunk(
  'https://support-desk-main-s-backend.vercel.app/tickets/getAll',
  async (_, thunkAPI) => {
    try {
      const token = thunkAPI.getState().auth.user.token
...
export const getTicket = createAsyncThunk(
  'https://support-desk-main-s-backend.vercel.app/tickets/get',
...
export const closeTicket = createAsyncThunk(
  'https://support-desk-main-s-backend.vercel.app/tickets/close',
  async (ticketId, thunkAPI) => {
    try {
      const token = thunkAPI.getState().auth.user.token
